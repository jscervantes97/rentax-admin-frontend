<template>
  <div class="add-property">
    <v-container>
      <h2 class="grey--text">Agregar propiedad</h2>
        ...
        <v-form ref="form" v-model="valid" lazy-validation>
          <v-container>
            <v-row>
              ...
              <v-col cols="12" md="6">
                <v-select :items="developments" label="Desarrollo" v-model="form.development" :rules="rules.development"></v-select>
              </v-col>
              <v-col cols="12" md="12">
              ...
              <v-col cols="12" md="4">
                <v-select :items="distintive" label="Distintivo" v-model="form.distinctive"></v-select>
              </v-col>
              <v-col cols="12" md="4">
              ...
              <v-col cols="3" md="3" v-for="(url, index) in urlsBannerMobile" :key="url">
                <div style="position:relative;">
                  <v-btn
                    ...
                    fab
                    style="position:absolute;z-index:3;top:-8px;right:20px;"
                    @click="removeImageBannerMobile(index)"
                  >
                    <v-icon>mdi-close</v-icon>
                  </v-btn>
                  <v-img :src="url" max-height="144px"></v-img>
              ...
              <v-col cols="3" md="3">
                <div style="height:144px;width:100%;" class="grey lighten-3">
                  <input
                    ...
                    block
                    multiple
                    @change="onFileChangeBannerMobile"
                  />
                  <label for="fileBannerMobile" class="grey lighten-3">
                    <span>
                      <v-icon>mdi-cloud-upload</v-icon>
                    </span>
                    <br />Agregar imagenes banner
