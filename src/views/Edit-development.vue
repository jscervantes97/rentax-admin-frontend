<template>
  <div class="add-property">
    <v-container>
      <h2 class="grey--text">Editar desarrollo</h2>
      <v-card class="mx-auto mt-4 pa-4" outlined>
        ...
        <v-form ref="form" v-model="valid" lazy-validation>
          <v-container>
            ...
            <v-row>           
              <v-col cols="3" md="3">
                <div v-if="!logoUrl" style="height:144px;width:100%;" class="grey lighten-3">
                  <input
                    id="logoFile"
                ...
                <!-- <p v-if="logoRule" class="error--text py-3">Ingresa la imagén del logo del desarrollo</p> -->
              </v-col>
